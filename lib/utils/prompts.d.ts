/** 判决结果到 Emoji 的映射 */
export declare const VERDICT_EMOJI: {
    true: string;
    false: string;
    partially_true: string;
    uncertain: string;
};
/**
 ...
 * 构建子搜索 Agent 的请求
 */
export declare function buildSubSearchPrompt(claim: any): string;
/**
 * fact_check 工具专用搜索请求
 */
export declare function buildFactCheckToolSearchPrompt(content: any): string;
/**
 * 构建 DeepSearch 计划 Prompt
 */
export declare function buildDeepSearchPlanPrompt(claim: any, history: any): string;
/**
 * 构建 DeepSearch 评估 Prompt
 */
export declare function buildDeepSearchEvaluatePrompt(claim: any, results: any, history: any): string;
/**
 * 构建 DeepSearch 综合 Prompt
 */
export declare function buildDeepSearchSynthesizePrompt(claim: any, history: any): string;
/**
 * 构建验证请求（支持多模态）
 */
export declare function buildVerifyPrompt(originalContent: any, searchResults: any, hasImages: any): string;
/**
 * 格式化验证结果为 Markdown 或纯文本
 */
export declare function formatVerificationOutput(content: any, searchResults: any, verdict: any, reasoning: any, sources: any, confidence: any, processingTime: any, format?: string): string;
/**
 * 格式化合并转发消息
 * 每个消息段限制在 OUTPUT.SEGMENT_MAX_CHARS 字符以内
 */
export declare function formatForwardMessages(content: any, searchResults: any, verdict: any, reasoning: any, sources: any, confidence: any, processingTime: any, maxSegmentLength?: number): {
    summary: string;
    details: any[];
};

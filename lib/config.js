...
const toolsSchema = koishi_1.Schema.intersect([
    ...
    koishi_1.Schema.object({
        webFetchEnable: koishi_1.Schema.boolean().default(true).description('启用 web_fetch 工具注册'),
...
const modelsSchema = koishi_1.Schema.object({
    grokModel: koishi_1.Schema.dynamic('model').default('x-ai/grok-4-1').description('FactCheck 使用的 Grok 来源模型（留空则跳过 Grok 来源）'),

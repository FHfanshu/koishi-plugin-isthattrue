...
export declare class ChatlunaAdapter {
    ...
    private static readonly MODEL_BLOCK_TTL_MS;
    private static readonly temporaryBlockedModels;
    ...
    private shouldStopRetryForCurrentModel;
    private isModelTemporarilyBlocked;
    private blockModelTemporarily;
